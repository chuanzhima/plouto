    ...
    public void settle(String sequence, String accountId, BigDecimal amount, String bankId, String merchantId,
        ...
        MerchantTransDetailDto.Builder builder1 = new MerchantTransDetailDto.Builder().serialNo(sequence)
                ...
                .transDate(transDate).status(AccountBizConstant.TRANS_DETAIL_STATUS_1).accDate(accDate).partyMarkNo
                        ...
                        getAmount1().add(amount)).userDefindMark(AccountBizConstant.TRANS_DETAIL_USER_DEFIND_MARK_1).
                        channel(channelEnum.name()).merchantId(merchantId);
        ...
        if (bizEnum == AccountBizEnum.NORMAL) {
            ...
            builder.accountCl(AccountBizConstant.YHK_AMOUNT_COLUMN).amount1(amount).amount11(merchantAccountInfoDto.
                    getAmount1().subtract(amount));
            builder1.accountCl(AccountBizConstant.YHK_AMOUNT_COLUMN).amount1(amount).amount11(merchantAccountInfoDto.
                    getAmount1().subtract(amount));
        }
